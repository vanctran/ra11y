...
>
> **ra11y-column numbers** generated by `scripts/benchmark-run.ts` on 2026-04-16 (source: `benchmarks/data/ra11y-2026-04-16.json`). Competitor numbers remain pending a separate pass that adds the comparison tools as isolated dev deps.
...
| Time to first scan (cold) | pending | pending (Chromium launch) | pending | 41.3ms |
...
|-------------|--------------------:|------:|----------------------:|------:|
| 10 files (~1k LOC) | pending | pending | pending | 3.4ms |
| 100 files (~10k LOC) | pending | pending | pending | 28.3ms |
| 1000 files (~100k LOC) | pending | pending | pending | 235.9ms |
